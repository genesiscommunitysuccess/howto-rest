systemDefinition {
    global {
        ...
        item(name = "DbHost", value = "jdbc:h2:file:~/genesis-local-db/howto-rest/h2/test;DB_CLOSE_DELAY=-1;NON_KEYWORDS=VALUE,KEY;AUTO_SERVER=TRUE")
        item(name = "DbQuotedIdentifiers", value = true)
        item(name = "DEPLOYED_PRODUCT", value = "howto-rest")
    ...
    systems {
        ...
        system(name = "DEV") {
            ...
            item(name = "DbNamespace", value = "HOWTO_REST")
