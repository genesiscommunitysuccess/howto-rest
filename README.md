...
Once you've started your docker container (or standalone application), set up the Genesis Application via the plugin (see [here](https://learn.genesis.global/docs/how-to/ht-run-examples/#running-the-app-locally) for how to run this application). Once running, you'll have tha ability to interact directly with the REST API's.
